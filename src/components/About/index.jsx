        ...
        >
          <p className="theme--detail--dark">
            <ScrambleText delay={2}>
              ...
              crafting seamless user experiences. Trained at Frontend
              Simplified, I have honed my skills in HTML, CSS, JavaScript, and
              modern frameworks. My commitment to continuous learning and
              problem-solving drives me to deliver high-quality, responsive web
              applications. I strive to enhance user engagement and streamline
              development processes through my technical expertise, innovative
              approach, and user-centric design. Excited to join a
              forward-thinking team, I bring creativity, technical prowess, and
